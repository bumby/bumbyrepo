...
#------------------------------observer implementaion ---------------        
    ...
    def display(self):
        print ('호가시간:',self.호가시간,' 매도호가1:',self.매도호가1, ' 매수호가1:',self.매수호가1, '단축코드:',self.단축코드)
#----------------------------------------------------------     
